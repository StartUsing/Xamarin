...
namespace XamarinTest.App
{
    public class CameraViewModel : ViewModel
    {
        ...
        private void Setup()
        {
            ...
            _mediaPicker = Xamarin.Forms.DependencyService.Get<IMediaPicker>() ?? device.MediaPicker;
        }
        ...
        private async Task<MediaFile> TakePicture()
        {
            ...
            {
                DefaultCamera = CameraDevice.Front, MaxPixelDimension = 50,
                PercentQuality=50
        ...
        public Action<MediaFile> OnSuccess { get; set; }

        public MediaFile ModelFile { get; set; }
